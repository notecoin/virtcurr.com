<br>
<h4>Email verification for new user<small> with virtcurr.com </small></h4>
<div class="row">
	<div class="col-xs-12 col-lg-4">
		<div class="panel panel-success">
			...
			<div class="panel-body">
				<?php echo $msg;?>
				<?=$this->form->create($Users,array('url'=>'/Users/confirm/','role'=>'form','class'=>'form-horizontal','style'=>'padding:10px')); ?>
